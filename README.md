...
for instance, it contains the correct number of `time` tags. Finally,
GatorGrader will check to ensure that your `site.css` and `table.css` files
contains the required styling rules. GatorGrader will also ensure that you
made the required number of commits to your repository and that your writing
...
[Travel Web Site Example](images/travels.png)
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-103-S2018/cs103-S2018-lab6-starter.git
```
